package com.psql.jdbc.dao;

import com.psql.jdbc.Customer;
import com.psql.jdbc.util.DataAccessObject;
...
public class CustomerDao extends DataAccessObject<Customer> {
    ...
    private static final String GET_ONE = "SELECT customer_id, first_name, last_name, email, phone, address, city, state, " +
            "zipcode FROM customer WHERE customer_id = ?";
